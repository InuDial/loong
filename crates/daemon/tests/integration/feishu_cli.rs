...
#[tokio::test]
async fn grouped_feishu_send_command_supports_post_content() {
    let temp_dir = temp_feishu_cli_dir("grouped-send-command-post");
    let requests = Arc::new(Mutex::new(Vec::<MockRequest>::new()));
    let state = MockServerState {
        requests: requests.clone(),
    };
            ...
            post({
                ...
                move |request| {
                    ...
                    async move {
                        ...
                        Json(json!({
                            "code": 0,
                            "tenant_access_token": "t-token-grouped-send-cli-post"
                        }))
                    }
                }
            }),
                ...
                move |request| {
                    ...
                    async move {
                        ...
                        Json(json!({
                            "code": 0,
                            "data": {
                                "message_id": "om_grouped_send_cli_post_1",
                                "root_id": "om_grouped_send_cli_post_1"
                            }
                        }))
                    }
                }
    ...
    assert!(
        requests[1]
            .body
            .contains("\"uuid\":\"grouped-send-post-uuid-1\"")
    );
