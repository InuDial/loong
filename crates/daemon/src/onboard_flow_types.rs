...
impl ReviewFlowStyle {
    pub(crate) const fn review_kind(self) -> crate::onboard_presentation::ReviewFlowKind {
        match self {
...
impl OnboardShortcutKind {
    pub(crate) const fn presentation_kind(self) -> crate::onboard_presentation::ShortcutKind {
        match self {
