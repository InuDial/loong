...
use super::pairing::{
    ...
    build_gateway_pairing_summary_read_model, build_operator_nodes_summary_read_model,
};
use super::{
...
pub(crate) fn build_operator_runtime_summary_read_model(
    ...
    GatewayOperatorRuntimeSummaryReadModel {
        enabled_channel_ids,
        enabled_runtime_backed_channel_ids: enabled_channel_rollups
            .enabled_runtime_backed_channel_ids,
        enabled_service_channel_ids: enabled_channel_rollups.enabled_service_channel_ids,
        enabled_plugin_backed_channel_ids: enabled_channel_rollups
            .enabled_plugin_backed_channel_ids,
        enabled_outbound_only_channel_ids: enabled_channel_rollups
...
fn summarize_operator_runtime_enabled_channels(
    ...
    GatewayOperatorRuntimeEnabledChannels {
        enabled_runtime_backed_channel_ids: runtime_snapshot
            ...
            .enabled_runtime_backed_channel_ids
            .clone(),
        enabled_service_channel_ids: runtime_snapshot
            .channels
            .enabled_service_channel_ids
            .clone(),
...
fn collect_channel_surface_recent_runtime_incidents(
    ...
    let mut incidents = surface
        ...
        .iter()
        .filter_map(channel_account_serve_runtime)
        .flat_map(build_runtime_incident_read_models)
        .collect::<Vec<_>>();
...
fn runtime_incident_kind_text(
    ...
    match kind {
        ...
        app::channel::ChannelOperationRuntimeIncidentKind::DuplicateReclaim => "duplicate_reclaim",
    }
}
...
pub(crate) fn build_operator_channel_surface_read_model(
    ...
    let service_ready = service_enabled
    ...
    GatewayOperatorChannelSurfaceReadModel {
        ...
        last_duplicate_runtime_auto_reclaim_at: runtime_rollups
        ...
        ready_serve_account_count: surface
            ...
            .filter(|account| {
                channel_account_operation_is_ready(
                    account,
                    app::channel::CHANNEL_OPERATION_SERVE_ID,
                )
            })
            .count(),
    }
...
mod tests {
    ...
    fn operator_channels_summary_read_model_collects_runtime_attention_surface_ids() {
        ...
        let channel_inventory =
            core::build_channel_inventory_read_model("/tmp/loong.toml", &inventory);
