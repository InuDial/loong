...
| --- | --- | --- |
| Feishu or Lark should own a live team-chat runtime | [Feishu/Lark](/use-loong/channel-guides/feishu) | it is the most feature-rich managed-bridge-capable service channel today |
| Telegram is enough for the live reply loop | [Telegram](/use-loong/channel-guides/telegram) | it is the smallest managed-bridge-capable service setup path |
| Matrix should own a self-hosted or federated room runtime | [Matrix](/use-loong/channel-guides/matrix) | homeserver and room trust boundaries stay explicit on a managed-bridge-capable service lane |
| WhatsApp Cloud API should own a business-account reply loop | [WhatsApp Cloud API](/use-loong/channel-guides/whatsapp) | direct sends and the webhook reply loop are both shipped on a managed-bridge-capable service lane |
| WeCom should own the official enterprise AIBot lane | [WeCom](/use-loong/channel-guides/wecom) | it aligns with the shipped managed-bridge-capable long-connection contract |
